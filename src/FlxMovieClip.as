...
package
{
    ...
    public class FlxMovieClip extends FlxObject
    {
        ...
        override public function render():void
        {
            ...
            FlxG.buffer.copyPixels(mcBuffer, frmRect[ frmIdx ], renderPt, null, null, true);
        }
        
        override public function overlaps(o:FlxObject):Boolean
        {
            getScreenXY(_point);
        ...
        override public function overlapsPoint(X:Number, Y:Number, PerPixel:Boolean = false):Boolean
        {
            ...
            var fr:int = getFrameIndex();
            _point.x  += bounds[ fr ].x;
            _point.y  += bounds[ fr ].y;
