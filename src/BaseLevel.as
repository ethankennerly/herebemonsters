...
package 
{
	...
	public class BaseLevel
	{
		...
		public function addSpriteToLayer(obj:FlxSprite, type:Class, layer:FlxGroup, x:Number, y:Number, angle:Number, flipped:Boolean = false, scaleX:Number = 1, scaleY:Number = 1, properties:Array = null, onAddCallback:Function = null):FlxSprite
		{
			...
			layer.add(obj,true);
			if(onAddCallback != null)
				onAddCallback(obj, layer, this, properties);
			return obj;
		}
		...
		protected function callbackNewData(data:Object, onAddCallback:Function, layer:FlxGroup, properties:Array):Object
		{
			if(onAddCallback != null)
				onAddCallback(data, layer, this, properties);
			return data;
		}
